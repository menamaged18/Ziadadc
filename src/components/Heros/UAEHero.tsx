...
const UAEHero: React.FC<IHero> = ({ setShowUaeHero, showUaeHero }) => {
  return (
    <section
      ...
      <div className="relative md:max-w-7xl max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="flex flex-col justify-center text-3xl md:text-4xl font-bold text-white md:mb-6 mb-3 leading-tight">
            ...
            <span className="block mx-auto mt-4 p-1 w-32 rounded-2xl text-white bg-red-800 transition-all transform hover:scale-105 duration-300">UAE</span>
          </h2>
